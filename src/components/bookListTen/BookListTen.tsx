...
interface BookListTenProps {
  books: Book[];
  heading: String;
}

export const BookListTen = ({ books, heading }: BookListTenProps) => {
  return (
    <div className="mb-8">
        ...
        {books.map((book, index) => (
          ...
          >
            <div className={`flex flex-col justify-start ${index === 0 ? "pr-4" : ""}`}>
              <h2 className="font-serif font-bold text-text mb-2">{`${index + 1}. ${book.title}`}</h2>
