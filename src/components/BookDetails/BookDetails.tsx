    ...
    <section className="bg-white p-16">
      <div className="flex flex-row">
        ...
        <div className="basis-7/12 px-10 py-4">
          ...
          <div className="basis-10/12 text-2xl text-center font-thin">
            {" "}
            {book.author}{" "}
          </div>

          <div className="flex flex-row py-2 pt-6">
            <div className="basis-1/2 text-xl text-center font-bold">
              {" "}
              “Fantastic” {/* Må kobles opp mot backend */}
              <div className="basis-1/2 text-sm text-center font-thin">
                {" "}
                6.0/6.0{" "}
              </div>{" "}
              {/* Må kobles opp mot backend */}
              <div className="basis-1/2 text-base text-center font-normal">
                {" "}
                The New York Times{" "}
              </div>{" "}
              {/* Må kobles opp mot backend */}
            ...
            <div className="basis-1/2 text-xl text-center font-bold">
              {" "}
              “A masterpiece” {/* Må kobles opp mot backend */}
              <div className="basis-1/2 text-sm text-center font-thin">
                {" "}
                5.8/6.0{" "}
              </div>{" "}
          ...
          <div className="flex flex-row py-2">
            <div className="basis-1/2 text-center ">
              ...
              <div className="basis-1/2 text-center ">5.7/6.0</div>{" "}
              {/* Må kobles opp mot backend */}
            </div>
            <div className="basis-1/2 text-center ">
              Reader ratings:
              <div className="basis-1/2 text-center ">5.9/6.0</div>{" "}
              {/* Må kobles opp mot backend */}
            </div>
          </div>
        </div>
